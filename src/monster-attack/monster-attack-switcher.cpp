...
void switch_monster_blow_to_player(PlayerType *player_ptr, monap_type *monap_ptr)
{
    ...
    case RaceBlowEffectType::ACID: {
        ...
        monap_ptr->get_damage += acid_dam(player_ptr, monap_ptr->damage, monap_ptr->ddesc, false).process();
        update_creature(player_ptr);
    ...
    case RaceBlowEffectType::ELEC: {
        ...
        monap_ptr->get_damage += elec_dam(player_ptr, monap_ptr->damage, monap_ptr->ddesc, false).process();
    ...
    case RaceBlowEffectType::FIRE: {
        ...
        monap_ptr->get_damage += fire_dam(player_ptr, monap_ptr->damage, monap_ptr->ddesc, false).process();

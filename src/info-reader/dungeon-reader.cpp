...
{
    if (EnumClassFlagGroup<MonraceKindType>::grab_one_flag(d_ptr->m_race_kind_flags, r_info_race_kind_flags, what))
        return true;
    ...
    if (EnumClassFlagGroup<MonsterResistanceType>::grab_one_flag(d_ptr->m_resistance_flags, r_info_resistance_flags, what))
        return true;

...
const std::unordered_map<std::string_view, MonsterAbilityType> r_info_ability_flags = {
	...
	{"BO_DARK", MonsterAbilityType::BO_DARK },
    {"DRAIN_LIFE", MonsterAbilityType::DRAIN_LIFE },
};
/* clang-format on */
 ...
 * Monster race flags
 */
const std::unordered_map<std::string_view, MonsterResistanceType> r_info_resistance_flags = {
 ...
 * Monster race flags
 */
const std::unordered_map<std::string_view, MonraceKindType> r_info_race_kind_flags = {
    { "UNIQUE", MonraceKindType::UNIQUE },
    { "NONLIVING", MonraceKindType::NONLIVING },
    { "HUMAN", MonraceKindType::HUMAN },
    { "QUANTUM", MonraceKindType::QUANTUM },
    { "ORC", MonraceKindType::ORC },
    { "TROLL", MonraceKindType::TROLL },
    { "GIANT", MonraceKindType::GIANT },
    { "DRAGON", MonraceKindType::DRAGON },
    { "DEMON", MonraceKindType::DEMON },
    { "AMBERITE", MonraceKindType::AMBERITE },
    { "ANGEL", MonraceKindType::ANGEL },
    { "EVIL", MonraceKindType::EVIL },

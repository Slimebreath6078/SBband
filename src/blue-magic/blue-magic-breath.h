...
class breath_caster {
protected:
    breath_caster(PlayerType *player_ptr, bmc_type *bmc_ptr, concptr typ_name, MonsterAbilityType ms_type, AttributeType typ);
...
public:
    breath_acid_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_elec_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_fire_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_cold_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_pois_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_nether_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_lite_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_dark_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_conf_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_sound_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_chaos_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_disenchant_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_nexus_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_time_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_inertia_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_gravity_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_shards_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_plasma_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_force_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_mana_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_nuke_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    breath_disintegration_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);

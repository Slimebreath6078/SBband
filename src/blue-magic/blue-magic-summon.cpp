...
summon_caster::summon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr, concptr msg, std::vector<summon_list> summons, int num)
...
summon_kin_caster::summon_kin_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_cyber_caster::summon_cyber_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_monster_caster::summon_monster_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_monsters_caster::summon_monsters_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_ant_caster::summon_ant_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_spider_caster::summon_spider_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_hound_caster::summon_hound_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_hydra_caster::summon_hydra_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_angel_caster::summon_angel_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_demon_caster::summon_demon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_undead_caster::summon_undead_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_dragon_caster::summon_dragon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_high_undead_caster::summon_high_undead_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_high_dragon_caster::summon_high_dragon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_amberite_caster::summon_amberite_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)
...
summon_unique_caster::summon_unique_caster(PlayerType *player_ptr, bmc_type *bmc_ptr)

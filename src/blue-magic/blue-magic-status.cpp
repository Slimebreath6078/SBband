...
status_caster::status_caster(PlayerType *player_ptr, bmc_type *bmc_ptr, concptr msg, std::function<bool(PlayerType *, DIRECTION, PLAYER_LEVEL)> func,
    PLAYER_LEVEL level)

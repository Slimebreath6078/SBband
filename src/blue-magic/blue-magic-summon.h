...
struct summon_list {
    summon_list(concptr msg_angry, summon_type type, BIT_FLAGS mode, std::function<bool(PlayerType *, MONSTER_IDX, POSITION, POSITION, DEPTH, summon_type, BIT_FLAGS)> summon);
    summon_list(concptr msg_angry, summon_type type, BIT_FLAGS mode, std::function<bool(PlayerType *, DEPTH, POSITION, POSITION, BIT_FLAGS)> summon);
...
class summon_caster {
protected:
    summon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr, concptr msg, std::vector<summon_list> summons, int num);
...
public:
    summon_kin_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_cyber_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_monster_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_monsters_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_ant_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_spider_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_hound_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_hydra_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_angel_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_demon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_undead_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_dragon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_high_undead_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_high_dragon_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_amberite_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);
...
public:
    summon_unique_caster(PlayerType *player_ptr, bmc_type *bmc_ptr);

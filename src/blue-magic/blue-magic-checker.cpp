...
void set_rf_masks(EnumClassFlagGroup<MonsterAbilityType> &ability_flags, BlueMagicType type)
{
    ...
    case BlueMagicType::BOLT:
        ability_flags.set(MonsterAbilityType_BOLT_MASK | MonsterAbilityType_BEAM_MASK).reset(MonsterAbilityType::ROCKET);
        break;

    case BlueMagicType::BALL:
        ability_flags.set(MonsterAbilityType_BALL_MASK).reset(MonsterAbilityType_BREATH_MASK);
        break;

    case BlueMagicType::BREATH:
        ability_flags.set(MonsterAbilityType_BREATH_MASK);
        break;

    case BlueMagicType::SUMMON:
        ability_flags.set(MonsterAbilityType_SUMMON_MASK);
        break;

    case BlueMagicType::OTHER:
        ability_flags.set(MonsterAbilityType_ATTACK_MASK);
        ability_flags.reset(MonsterAbilityType_BOLT_MASK | MonsterAbilityType_BEAM_MASK | MonsterAbilityType_BALL_MASK | MonsterAbilityType_INDIRECT_MASK);
        break;
    }
}

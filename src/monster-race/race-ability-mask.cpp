...
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_SUMMON_MASK = {
...
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_INT_MASK =
    EnumClassFlagGroup<MonsterAbilityType>(MonsterAbilityType_SUMMON_MASK).set({
...
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_RIDING_MASK = {
 ...
 */
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_BOLT_MASK = {
    ...
    MonsterAbilityType::BO_LITE, MonsterAbilityType::BO_DARK,
};
 ...
 */
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_BEAM_MASK = {
 ...
 */
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_BIG_BALL_MASK = {
 ...
 */
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_BREATH_MASK = {
 ...
 */
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_BALL_MASK =
    (MonsterAbilityType_BIG_BALL_MASK | MonsterAbilityType_BREATH_MASK).set({
...
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_ATTACK_MASK =
    (MonsterAbilityType_BOLT_MASK | MonsterAbilityType_BEAM_MASK | MonsterAbilityType_BALL_MASK).set({
...
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_INDIRECT_MASK =
    EnumClassFlagGroup<MonsterAbilityType>(MonsterAbilityType_SUMMON_MASK).set({
...
const EnumClassFlagGroup<MonsterAbilityType> MonsterAbilityType_NOMAGIC_MASK =
    EnumClassFlagGroup<MonsterAbilityType>(MonsterAbilityType_BREATH_MASK).set({

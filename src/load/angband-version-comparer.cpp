...
/*!
 * @brief SBbandのバージョン比較処理 / This function determines if the version of the savefile currently being read is older than version
...
/*!
 * @brief [互換性用/新規仕様禁止]SBbandのバージョン比較処理 / The above function, adapted for SBband
 * @param major メジャーバージョン値
 * @param minor マイナーバージョン値
 * @param patch パッチバージョン値
 * @return 現在のバージョンより値が古いならtrue

...
constexpr auto MIN_RANDOM_QUEST = enum2i(quest_id::RANDOM_QUEST1);
constexpr auto MAX_RANDOM_QUEST = enum2i(quest_id::RANDOM_QUEST10);
...
public:
    ...
    static bool is_fixed(int16_t quest_idx);
};

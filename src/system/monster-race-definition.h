...
struct monster_race {
    ...
    EnumClassFlagGroup<MonraceIndividualityType> individuality_flags; //!< その他特性フラグ / Other-Individuality Flags
    ...
    EnumClassFlagGroup<MonraceIndividualityType> r_individuality_flags; //!< 見た能力フラグ(その他特性フラグ) / Observed other-individuality flags

...
struct monster_race {
    ...
    EnumClassFlagGroup<MonraceKindType> population_flags; //!< 能力フラグ（出現数） / Population Flags
    ...
    EnumClassFlagGroup<MonraceKindType> r_population_flags; //!< 見た能力フラグ（出現数） / Observed population flags

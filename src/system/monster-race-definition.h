...
#include "monster-race/race-sight-flags.h"
...
struct monster_race {
    ...
    EnumClassFlagGroup<MonraceSightType> sight_flags; //!< 能力フラグ（明かり・闇） / Lite and Dark Flags
    ...
    EnumClassFlagGroup<MonraceSightType> r_sight_flags; //!< 見た能力フラグ（明かり・闇） / Observed racial Lite and Dark flags

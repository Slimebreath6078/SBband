...
struct monster_race {
    ...
    EnumClassFlagGroup<MonraceBehaviorType> race_behavior_flags; //!< 能力フラグ（習性）
    ...
    EnumClassFlagGroup<MonraceBehaviorType> r_race_behavior_flags; //!< 見た能力フラグ（習性） / Observed racial attr flags

...
struct monster_race {
    ...
    EnumClassFlagGroup<MonraceVisualType> visual_flags; //!< 能力フラグ（シンボル） / Symbol Flags
    ...
    EnumClassFlagGroup<MonraceVisualType> r_visual_flags; //!< 見た能力フラグ（シンボル） / Observed racial symbol flags

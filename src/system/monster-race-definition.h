...
struct monster_race {
    ...
    EnumClassFlagGroup<MonraceFeatureType> feature_flags; //!< 能力フラグ（地形関連） / Feature Flags
    ...
    EnumClassFlagGroup<MonraceFeatureType> r_feature_flags; //!< 見た能力フラグ(地形関連) / Observed feature flags

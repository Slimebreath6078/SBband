...
static void check_mspell_stupid(PlayerType *player_ptr, msa_type *msa_ptr)
{
    ...
    msa_ptr->in_no_magic_dungeon = d_info[player_ptr->dungeon_idx].flags.has(DungeonFeatureType::NO_MAGIC) && floor_ptr->dun_level && (!floor_ptr->quest_number || quest_type::is_fixed(floor_ptr->quest_number));

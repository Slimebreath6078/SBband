...
static HIT_POINT monspell_damage_base(
    player_type *target_ptr, int r_idx, RF_ABILITY ms_type, int hp, int rlev, bool powerful, int shoot_dd, int shoot_ds, int shoot_base, int TYPE)
{
...
HIT_POINT monspell_damage(player_type *target_ptr, RF_ABILITY ms_type, MONSTER_IDX m_idx, int TYPE)
{
    ...
    return monspell_damage_base(target_ptr, m_ptr->r_idx, ms_type, hp, rlev, monster_is_powerful(floor_ptr, m_idx), shoot_dd, shoot_ds, 0, TYPE);
}
...
HIT_POINT monspell_race_damage(player_type *target_ptr, RF_ABILITY ms_type, MONRACE_IDX r_idx, int TYPE)
{
    ...
    monspell_shoot_dice(r_ptr, &shoot_dd, &shoot_ds);
    return monspell_damage_base(target_ptr, r_idx, ms_type, MIN(30000, hp), rlev, powerful, shoot_dd, shoot_ds, 0, TYPE);
}
...
HIT_POINT monspell_bluemage_damage(player_type *target_ptr, RF_ABILITY ms_type, PLAYER_LEVEL plev, int TYPE)
{
    ...
    return monspell_damage_base(target_ptr, 0, ms_type, hp, plev * 2, false, shoot_dd, shoot_ds, shoot_base, TYPE);
}

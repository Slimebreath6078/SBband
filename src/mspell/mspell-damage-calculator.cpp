...
static HIT_POINT monspell_damage_base(
    player_type *player_ptr, int r_idx, RF_ABILITY ms_type, int hp, int rlev, bool powerful, int shoot_dd, int shoot_ds, int shoot_base, int TYPE)
{
...
HIT_POINT monspell_race_damage(player_type *player_ptr, RF_ABILITY ms_type, MONRACE_IDX r_idx, int TYPE)
{
    ...
    monspell_shoot_dice(r_ptr, &shoot_dd, &shoot_ds);
    return monspell_damage_base(player_ptr, r_idx, ms_type, MIN(30000, hp), rlev, powerful, shoot_dd, shoot_ds, 0, TYPE);
}

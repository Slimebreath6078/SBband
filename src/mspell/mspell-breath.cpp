...
MonsterSpellResult spell_RF4_BREATH(PlayerType *player_ptr, AttributeType GF_TYPE, POSITION y, POSITION x, MONSTER_IDX m_idx, MONSTER_IDX t_idx, int TARGET_TYPE)
{
    ...
    case AttributeType::ACID:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_ACID, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("酸", "acid");
        drs_type = DRS_ACID;
        break;
    case AttributeType::ELEC:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_ELEC, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("稲妻", "lightning");
        drs_type = DRS_ELEC;
        break;
    case AttributeType::FIRE:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_FIRE, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("火炎", "fire");
        drs_type = DRS_FIRE;
        break;
    case AttributeType::COLD:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_COLD, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("冷気", "frost");
        drs_type = DRS_COLD;
        break;
    case AttributeType::POIS:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_POIS, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("ガス", "gas");
        drs_type = DRS_POIS;
        break;
    case AttributeType::NETHER:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_NETH, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("地獄", "nether");
        drs_type = DRS_NETH;
        break;
    case AttributeType::LITE:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_LITE, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("閃光", "light");
        drs_type = DRS_LITE;
        break;
    case AttributeType::DARK:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_DARK, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("暗黒", "darkness");
        drs_type = DRS_DARK;
        break;
    case AttributeType::CONFUSION:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_CONF, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("混乱", "confusion");
        drs_type = DRS_CONF;
        break;
    case AttributeType::SOUND:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_SOUN, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("轟音", "sound");
        drs_type = DRS_SOUND;
        break;
    case AttributeType::CHAOS:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_CHAO, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("カオス", "chaos");
        drs_type = DRS_CHAOS;
        break;
    case AttributeType::DISENCHANT:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_DISE, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("劣化", "disenchantment");
        drs_type = DRS_DISEN;
        break;
    case AttributeType::NEXUS:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_NEXU, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("因果混乱", "nexus");
        drs_type = DRS_NEXUS;
        break;
    case AttributeType::TIME:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_TIME, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("時間逆転", "time");
        smart_learn_aux = false;
        break;
    case AttributeType::INERTIAL:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_INER, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("遅鈍", "inertia");
        smart_learn_aux = false;
        break;
    case AttributeType::GRAVITY:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_GRAV, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("重力", "gravity");
        smart_learn_aux = false;
        break;
    case AttributeType::SHARDS:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_SHAR, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("破片", "shards");
        drs_type = DRS_SHARD;
        break;
    case AttributeType::PLASMA:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_PLAS, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("プラズマ", "plasma");
        smart_learn_aux = false;
        break;
    case AttributeType::FORCE:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_FORC, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("フォース", "force");
        smart_learn_aux = false;
        break;
    case AttributeType::MANA:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_MANA, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("魔力", "mana");
        smart_learn_aux = false;
        break;
    case AttributeType::NUKE:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_NUKE, m_idx, damage_flag_type::DAM_ROLL);
        type_s = _("放射性廃棄物", "toxic waste");
        drs_type = DRS_POIS;
        break;
    case AttributeType::DISINTEGRATE:
        dam = monspell_damage(player_ptr, MonsterAbilityType::BR_DISI, m_idx, damage_flag_type::DAM_ROLL);

...
struct SpellMsgToPlayer{
    SpellMsgToPlayer(concptr msg_blind, concptr msg_not_blind, concptr msg_resist, concptr msg_saving_throw);
    concptr msg_blind;
...
struct SpellMsgToMons{
    SpellMsgToMons(concptr msg_default, concptr msg_resist, concptr msg_saving_throw, concptr msg_success);
    concptr msg_default;
    concptr msg_resist;
    concptr msg_saving_throw;
    concptr msg_success;

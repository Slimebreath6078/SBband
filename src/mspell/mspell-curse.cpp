    ...
    const SpellMsg &msgs, int TARGET_TYPE)
{
    ...
    monspell_message(target_ptr, m_idx, t_idx, msgs, TARGET_TYPE);
...
MonsterSpellResult spell_RF5_CAUSE_1(player_type *target_ptr, POSITION y, POSITION x, MONSTER_IDX m_idx, MONSTER_IDX t_idx, int TARGET_TYPE)
{
    ...
    const auto dam = monspell_damage(target_ptr, RF_ABILITY::CAUSE_1, m_idx, DAM_ROLL);

    return spell_RF5_CAUSE(target_ptr, GF_CAUSE_1, dam, y, x, m_idx, t_idx, msgs, TARGET_TYPE);
}
...
MonsterSpellResult spell_RF5_CAUSE_2(player_type *target_ptr, POSITION y, POSITION x, MONSTER_IDX m_idx, MONSTER_IDX t_idx, int TARGET_TYPE)
{
    ...
    const auto dam = monspell_damage(target_ptr, RF_ABILITY::CAUSE_2, m_idx, DAM_ROLL);

    return spell_RF5_CAUSE(target_ptr, GF_CAUSE_2, dam, y, x, m_idx, t_idx, msgs, TARGET_TYPE);
}
...
MonsterSpellResult spell_RF5_CAUSE_3(player_type *target_ptr, POSITION y, POSITION x, MONSTER_IDX m_idx, MONSTER_IDX t_idx, int TARGET_TYPE)
{
    ...
    const auto dam = monspell_damage(target_ptr, RF_ABILITY::CAUSE_3, m_idx, DAM_ROLL);

    return spell_RF5_CAUSE(target_ptr, GF_CAUSE_3, dam, y, x, m_idx, t_idx, msgs, TARGET_TYPE);
}
...
MonsterSpellResult spell_RF5_CAUSE_4(player_type *target_ptr, POSITION y, POSITION x, MONSTER_IDX m_idx, MONSTER_IDX t_idx, int TARGET_TYPE)
{
    ...
    const auto dam = monspell_damage(target_ptr, RF_ABILITY::CAUSE_4, m_idx, DAM_ROLL);

    return spell_RF5_CAUSE(target_ptr, GF_CAUSE_4, dam, y, x, m_idx, t_idx, msgs, TARGET_TYPE);
}
